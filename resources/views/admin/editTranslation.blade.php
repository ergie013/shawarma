    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.updateTranslation') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label"><strong>Facebook Login Title</strong></label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="FBLoginTitle"
                            value="{{ $data->FBLoginTitle }}" placeholder="Facebook Login Title">
                    </div>
                </div>
                <div class="form-group row">
